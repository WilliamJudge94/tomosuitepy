...
def shortened_training_list(array, every_n_data):
    ...
    cropped_data = np.reshape(sectioned_out_data_trim,
                              (int(shape_trim[0] * shape_trim[1], )))
...
def make_file_list4deepfillv2(basedir, every_n_data_train=1, every_n_data_test=1):
    ...
    for dir_item in dirs:
        ...
        if '.ipynb_checkpoints' not in dir_item:
            ...
            training_file_names = shortened_training_list(
                training_file_names, every_n_data_train)
            ...
            validation_file_names = shortened_training_list(
                validation_file_names, every_n_data_test)
...
def edit_yml_file(basedir, img_shapes=[512, 512, 3], height=144, max_delta_height=0,
    ...
    data_flist = {}
    data_flist[dataset] = [f'{basedir}deepfillv2/data_flist/train_shuffled.flist',
                           f'{basedir}deepfillv2/data_flist/validation_shuffled.flist']
